// Mensajes A2UI de ejemplo -- copiados TAL CUAL de una corrida real de
// `mcp-agent/src/mcp-servers/ui-server.ts` (tool render_component,
// component: "service_spike_card"). Útiles para:
